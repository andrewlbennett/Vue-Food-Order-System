<template>
    <div id="order-screen">
        ...
        <div id="menu-items">
            ...
            <button v-on:click="addItem('fries', 2.39)" class="btn">Add Fries - 2.39</button>
            <button v-on:click="addItem('drink', 1.29)" class="btn">Add Drink - 1.29</button>
            <button v-on:click="addItem('cheesecake', 3.99)" class="btn">Add Cheesecake - 3.99</button>
        </div>
        <!-- /Menu -->
        <!-- Receipt -->
        <div id="receipt">
